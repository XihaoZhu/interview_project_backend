...
class EventException(models.Model):
    ...
    new_type = models.CharField(choices=[("meeting", "meeting"), ("event", "event"),("first_appointment", "first_appointment"),("presentation", "presentation")], max_length=50, blank=True, null=True)
